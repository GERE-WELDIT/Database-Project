        ...
        <div class='container'>
                ...
                $userConn = mysqli_connect($servername,$_SESSION['userDBAccount'],$_SESSION['userDBAccountPassword'],$db);
                     ...
                     if($userConn){ // when connection is established.
                        ...
                        if($retrievedRusultProfile->num_rows > 0){
                            ...
                            $temp_drivers = '<br><h2>User(s) Profile</h2><br>';
                            while($row = mysqli_fetch_array($retrievedRusultProfile)){
                                ...
                                $temp_drivers.="<th><a href='deleteDriver.php?lno=$row[license_no]' class='btn'> delete</a></th>";
                                $temp_drivers.="<th><a href='editDriver.php?lno=$row[license_no]' class='btn' > edit</a></th>";
                                $temp_drivers.="</tr>"; 
                            }
            ...
            <div class="drivers-section">
                    ...
                    <div class='car-form-container' >
                        ...
                        <form action= '../searchDriver.html' method='post' class='returnBtn'>
                            <input type='submit' value='search driver' name='search' class='btn'>
                        </form>
                        <form action= '../registerDriverForm.html' method='post' class='returnBtn'>
                            <input type='submit' value='register driver' name='register ' class='btn'>
                        </form>
